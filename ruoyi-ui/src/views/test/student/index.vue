    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['test:student:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listStudent, getStudent, delStudent, addStudent, updateStudent } from "@/api/test/student";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('test/student/export', {
        ...this.queryParams
      }, `system_student.xlsx`)
    }
  }
